...
```bash
   git clone https://github.com/kerwilgil/cowork-session-cleaner.git
...
This opens an interactive menu showing your Cowork sessions.
...
Claude stores Cowork sessions locally, but there's no built-in way to manage them. I identified this gap and built a complete solution from scratch with:
- **Spanish support** (not available elsewhere)
- **Windows support** (no other tools support it well)
...
Se abre un menú interactivo mostrando tus sesiones de Cowork.
...
Claude almacena sesiones de Cowork localmente, pero no hay forma incorporada de gestionarlas. Identifiqué esta brecha y construí una solución completa desde cero con:
- **Soporte en español** (no disponible en otras partes)
- **Soporte para Windows** (ninguna otra herramienta lo soporta bien)
